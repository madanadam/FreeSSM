...
SSMFlagbyteDefinitions_tr::SSMFlagbyteDefinitions_tr()
{
	...
	_MB_defs_tr
	<< "1;1;3;00000F;00000E;Motor Hızı;devir;/4;0"
	...
	<< "2;7;1;000011;;Ateşleme Zamanlaması;derece;-128/2;1"
	<< "2;8;1;000010;;Araç Hızı;km/sa;*1;0"
	<< "3;1;1;000023;;Atmosfer Basıncı;kPa;*1;0"
	<< "3;2;1;000022;;Tekleme Düzeltmesi;derece;-128/2;1"
	...
	<< "4;4;1;000028;;Öğrenilmiş Ateşleme Zamanlaması;derece;-128/2;1"
	...
	<< "6;3;1;000039;;Egzoz Gazı Devridaimi (EGR) Adım Sayısı;adım;*1;0"
	<< "6;4;1;000038;;Rölanti Devri Kontrol (ISC) Valfi Adım Sayısı;adım;*1;0"
	...
	<< "7;7;1;00003D;;Değişken Valf Zamanlaması (VVT) Ön Açı Miktarı (Sol, Emiş);derece;-50;0"
	<< "7;8;1;00003C;;Değişken Valf Zamanlaması (VVT) Ön Açı Miktarı (Sağ, Emiş);derece;-50;0"
	...
	<< "8;7;1;000045;;Hava/Yakıt Sensörü #2 Direnci;ohm;*1;0"
	<< "8;8;1;000044;;Hava/Yakıt Sensörü #1 Direnci;ohm;*1;0"
	<< "9;1;2;00004F;;Türbin Devir Hızı;devir;*32;0"
	...
	<< "9;6;3;00004A;;Vites Konumu;vites;+1;0"
	...
	<< "9;8;2;000048;;Ön Teker Hızı;km/sa;*1;0"
	<< "10;1;2;000057;;Düşük Kavrama Görevi;%;/2;1"
	...
	<< "10;7;2;000051;;Arka Teker Hızı;km/sa;*1;0"
	<< "10;8;2;000050;;Fren Kavraması Çalışma Oranı;%;/2;1"
	<< "11;1;2;00005F;;Merkezi Diferansiyel Gösterge Akımı;A;/32;2"
	<< "11;2;2;00005E;;Merkezi Diferansiyel Gerçek Akımı;A;/32;2"
	<< "11;3;2;00005D;;AT Türbin Hızı 2;devir;*32;0"
	<< "11;4;2;00005C;;AT Türbin Hızı 1;devir;*32;0"
	<< "11;5;2;00005B;;Merkezi Diferansiyel Şalter Gerilimi;V;/51;2"
	<< "11;6;2;00005A;;ATF Sıcaklığı 2;°C;-50;0"
	<< "11;7;2;000059;;Düşük ve Geri Fren (L&R B) Görevi;%;/2;1"
	<< "11;8;2;000058;;Yüksek Kavrama Görevi;%;/2;1"
	...
	<< "36;7;1;000119;;Değişken Valf Zamanlaması (VVT) Gecikme Açısı (Sol, Egzoz);derece;-50;0"
	<< "36;8;1;000118;;Değişken Valf Zamanlaması (VVT) Gecikme Açısı (Sağ, Egzoz);derece;-50;0"
	...
	<< "45;4;2;00015A;00008D;Direksiyon Açı Sensörü;derece;s16*1;0"
	<< "45;5;2;00013F;;Teker Hızı Arka Sol;km/sa;*1;0"
	<< "45;6;2;00013E;;Teker Hızı Arka Sağ;km/sa;*1;0"
	<< "45;7;2;00013D;;Teker Hızı Ön Sol;km/sa;*1;0"
	<< "45;8;2;00013C;;Teker Hızı Ön Sağ;km/sa;*1;0"
	<< "48;1;1;000199;;Tekleme Düzeltmesi;derece;-128/4;1"
	<< "48;2;1;0000F9;;Öğrenilmiş Ateşleme Zamanlaması Düzeltmesi;derece;/16;1"
	...
	<< "53;1;1;0001E9;;Egzoz Gazı Devridaimi (EGR) Valfi Açma Açısı;derece;-50;0"
	<< "53;2;1;0001E8;;Egzoz Gazı Devridaimi (EGR) Hedef Valfi Açma Açısı;derece;-50;0"
	...
	<< "54;4;1;0001EF;0001EE;Hedef Motor Hızı;devir;/4;0"
	...
	<< "55;8;2;0001F1;;Sapma Oranı;derece/s;s8*0.19118;0"
	...
	<< "56;5;1;000270;;İç Isıtıcı;adım;*1;0"
	...
	<< "64;6;2;000295;;ABS/VDC Arka Teker Ortalama Teker Hızı;km/sa;*230/255;0"
	<< "64;7;2;000294;;ABS/VDC Ön Teker Ortalama Teker Hızı;km/sa;*230/255;0"
	...
	<< "65;7;1;000299;;Birikmiş Aşırı Hız Örneklerinin Sayısı (Yüksek Devir);Time;*1;0"
	...
	<< "23;3;2;00006C;Düşük Kavrama Zamanlaması Solenoidi;Kapalı/Açık"
	...
	<< "000096;0000AC;3;73;Düşük Kavrama Zamanlaması Solenoid Valfi"
	<< "000096;0000AC;4;74;Fren Kavrama Zamanlaması Solenoid Valfi"
	...
	// Adjustments:
	_adjustment_defs_tr
	<< "26-5;0;6F;;Ateşleme Zamanlaması Düzeltmesi;derece;0;5;0;*-1;0"
	<< "26-4;0;70;;Rölanti Hızı Düzeltme (Klima Kapalı);devir;124;140;128;-128*25;0"
	<< "26-3;0;71;;Rölanti Hızı Düzeltme (Klima Açık);devir;124;140;128;-128*25;0"
	...
	<< "27-5;1;81;;Meyil Kontrolü;;0;1;0;0=İzin Var,1=Erişim Yok;"
